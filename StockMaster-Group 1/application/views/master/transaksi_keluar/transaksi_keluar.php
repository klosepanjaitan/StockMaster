 	...
 	<div class="card shadow mb-4">
 		<div class="card-header py-3">
 			...
 			<a href="<?php echo base_url('Transaksi-keluar-add')?>">
 				<button class="btn btn-sm btn-success" type=""><i class="fas fa-plus fa-sm"></i> Tambah Transaksi Keluar</button></a>
 			<?php
              endif;
              ?>
 		</div>
 						...
 						<tr>
                             ...
                             <?php 
                                ...
                                ?>
 								...
 								<a href="<?=site_url('Transaksi-keluar-add')?>" class="btn btn-success btn-circle" title="Add">
