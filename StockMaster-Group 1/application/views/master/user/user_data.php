        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <?php echo anchor('user/add', '<button class="btn btn-sm btn-success" type=""><i class="fas fa-plus fa-sm"></i>Tambah User</button>') ?>
            </div>
            <div class="card-body">
                    ...
                    if (!empty($data)) : ?>
                      <?php foreach ($data as $row) : ?>
                        <tr>
                          ...
                          <td><?= $row->blokir ?></td>
                          <td>
                            <a href="<?= site_url('user/update/' . $row->user_id) ?>" class="btn btn-warning btn-circle">
