	...
	<div class="row">
		...
		<div class="col-lg-6">
			...
			<div class="card shadow mb-12">
				<div class="card-body">
					<form method="post" action="<?=base_url('Barang-update')?>" autocomplete="off">
                        <input type="hidden" name="barang_id" value="<?php echo $barang->pk_barang_id ?>">
						<div class="form-group col-lg-12">
							<label>Nama Barang *</label>
							<input type="text" name="nama_barang" class="form-control" name="" id="" value="<?php echo $barang->nama_barang ?>";>
						</div>
						<div class="form-group col-lg-12">
